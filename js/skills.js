...
// Skills data
const skills = [
  { name: "Software Engineering", badgeSupported: true, statuses: ['IN DEMAND', 'TRENDING', 'FUTURE PROOF'] },
  { name: "Agile and Scrum", badgeSupported: true, statuses: [] },
  { name: "Application Development", badgeSupported: true, statuses: [] },
  { name: "Artificial Intelligence", badgeSupported: true, statuses: [] },
  ...
  { name: "Cloud Applications", badgeSupported: true, statuses: [] },
  ...
  { name: "CSS", badgeSupported: true, statuses: [] },
  { name: "Data Analysis", badgeSupported: true, statuses: [] },
  { name: "Data Science", badgeSupported: true, statuses: [] },
  { name: "Distributed Version Control Systems", badgeSupported: true, statuses: [] },
  { name: "Django", badgeSupported: true, statuses: [] },
  { name: "Docker", badgeSupported: true, statuses: [] },
  { name: "Extract Transform and Load (ETL)", badgeSupported: true, statuses: [] },
  { name: "Flask", badgeSupported: true, statuses: [] },
  { name: "GitHub", badgeSupported: true, statuses: [] },
  { name: "Git", badgeSupported: true, statuses: [] },
  { name: "Kubernetes", badgeSupported: true, statuses: [] },
  { name: "Linux", badgeSupported: true, statuses: [] },
  { name: "Linux Commands", badgeSupported: true, statuses: [] },
  { name: "Logging", badgeSupported: true, statuses: [] },
  { name: "Microservices", badgeSupported: true, statuses: [] },
  { name: "MongoDB", badgeSupported: true, statuses: [] },
  { name: "Monitoring", badgeSupported: true, statuses: [] },
  { name: "NumPy", badgeSupported: true, statuses: [] },
  { name: "Object-Relational Mapping", badgeSupported: true, statuses: [] },
  { name: "Object-Oriented Programming", badgeSupported: true, statuses: [] },
  { name: "Observability", badgeSupported: true, statuses: [] },
  ...
  { name: "Pandas", badgeSupported: true, statuses: [] },
  { name: "Python", badgeSupported: true, statuses: [] },
  { name: "Relational Database", badgeSupported: true, statuses: [] },
  { name: "Representational State Transfer (REST)", badgeSupported: true, statuses: [] },
  { name: "Security", badgeSupported: true, statuses: [] },
  { name: "Serverless", badgeSupported: true, statuses: [] },
  { name: "Software Architecture", badgeSupported: true, statuses: [] },
  { name: "Software Development Lifecycle", badgeSupported: true, statuses: [] },
  { name: "SQL", badgeSupported: true, statuses: [] },
  { name: "Telemetry", badgeSupported: true, statuses: [] },
  { name: "Tracing", badgeSupported: true, statuses: [] },
  { name: "Web Application", badgeSupported: true, statuses: [] },
  { name: "Application Architecture and Design", badgeSupported: true, statuses: [] },
  { name: "Data Structures", badgeSupported: true, statuses: [] },
  { name: "Shell Scripting", badgeSupported: true, statuses: [] },
  { name: "Software Testing and Deployment", badgeSupported: true, statuses: [] },
  ...
  { name: "GraphQL", badgeSupported: true, statuses: [] },
  ...
  { name: "HTML", badgeSupported: true, statuses: [] },
  ...
  { name: "UNIX Shell Commands", badgeSupported: true, statuses: [] },
  { name: "Code Repositories", badgeSupported: true, statuses: [] },
  { name: "Collaboration", badgeSupported: true, statuses: [] },
  ...
  { name: "Software Development", badgeSupported: true, statuses: [] },
